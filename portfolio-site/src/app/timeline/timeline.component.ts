...
export class TimelineComponent {
    ...
    constructor() {
        ...
        this.exps = [
            {
                title: "Front End Developer Intern", org: "MindHome", startDate: "October 2021", endDate: "May 2022", description: "I leveraged Builder.io for the development process and implemented a new design for Mindhome's e-commerce site, specifically focusing on the 5 product pages. These redesigned pages were aimed at enhancing the browsing experience for all customers. Throughout this project, I gained valuable experience in web development while adhering to agile principles. Our scrum meetings were effectively organized and managed using Notion."
            },
            {
                title: "Web Development Branch Head", org: "SPARC at SIUE", startDate: "April 2021", endDate: "May 2022", description: "I collaborated with fellow students to create a website that showcased our organization. We utilized React for development and hosted the website using GitHub Pages. To ensure efficient progress, I managed the development process by implementing agile principles and utilizing project management software, Trello. Through this project, I gained valuable experience in teamwork, web development, and project management."
            },
            {
            ...
            {
                title: "Undergraduate Research Assistant", org: "URCA at SIUE", startDate: "August 2022", endDate: "March 2023", description: "Our SIUE team utilized the OpenPose open-source library to extract crucial information from cameras of over 120 human body joints and develop a Python program that extrapolates gait data . The extrapolated data will then be forwarded to researchers at NIU, who will utilize it to construct predictive models to identify early signs of autism in children. "
            },
            {
